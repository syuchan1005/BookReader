...
export const MigrationBooksDocument = gql`
    query migrationBooks($bookIds: [ID!]!) {
  books(ids: $bookIds) {
    bookId: id
    updatedAt
    info {
...
/**
 * __useMigrationBooksQuery__
 *
 * To run a query within a React component, call `useMigrationBooksQuery` and pass it any options that fit your needs.
 * When your component renders, `useMigrationBooksQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMigrationBooksQuery({
 *   variables: {
 *      bookIds: // value for 'bookIds'
 *   },
 * });
 */
export function useMigrationBooksQuery(baseOptions: Apollo.QueryHookOptions<MigrationBooksQuery, MigrationBooksQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MigrationBooksQuery, MigrationBooksQueryVariables>(MigrationBooksDocument, options);
      }
export function useMigrationBooksLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MigrationBooksQuery, MigrationBooksQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MigrationBooksQuery, MigrationBooksQueryVariables>(MigrationBooksDocument, options);
        }
export type MigrationBooksQueryHookResult = ReturnType<typeof useMigrationBooksQuery>;
export type MigrationBooksLazyQueryHookResult = ReturnType<typeof useMigrationBooksLazyQuery>;
export type MigrationBooksQueryResult = Apollo.QueryResult<MigrationBooksQuery, MigrationBooksQueryVariables>;
