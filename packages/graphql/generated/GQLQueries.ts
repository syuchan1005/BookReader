...
export const CropPagesDocument = gql`
  ...
  crop: cropPages(id: $id, pages: $pages, left: $left, width: $width) {
    ...
    `;
export type CropPagesMutationFn = Apollo.MutationFunction<CropPagesMutation, CropPagesMutationVariables>;

/**
 * __useCropPagesMutation__
 *
 * To run a mutation, you first call `useCropPagesMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCropPagesMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [cropPagesMutation, { data, loading, error }] = useCropPagesMutation({
 *   variables: {
 *      id: // value for 'id'
 ...
 * });
 */
export function useCropPagesMutation(baseOptions?: Apollo.MutationHookOptions<CropPagesMutation, CropPagesMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CropPagesMutation, CropPagesMutationVariables>(CropPagesDocument, options);
      }
export type CropPagesMutationHookResult = ReturnType<typeof useCropPagesMutation>;
export type CropPagesMutationResult = Apollo.MutationResult<CropPagesMutation>;
export type CropPagesMutationOptions = Apollo.BaseMutationOptions<CropPagesMutation, CropPagesMutationVariables>;
export const DeletePagesDocument = gql`
    mutation deletePages($id: ID!, $pages: IntRange!) {
  del: deletePages(id: $id, pages: $pages) {
    success
    code
  }
}
 ...
 * });
 */
export function useDeletePagesMutation(baseOptions?: Apollo.MutationHookOptions<DeletePagesMutation, DeletePagesMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
...
export const EditPageDocument = gql`
    mutation editPage($id: ID!, $page: Int!, $image: Upload!) {
  edit: editPage(id: $id, page: $page, image: $image) {
    success
    code
  }
}
...
export const PutPageDocument = gql`
    mutation putPage($id: ID!, $beforePage: Int!, $image: Upload!) {
  put: putPage(id: $id, beforePage: $beforePage, image: $image) {
    success
    code
  }
}
    `;
export type PutPageMutationFn = Apollo.MutationFunction<PutPageMutation, PutPageMutationVariables>;

/**
 * __usePutPageMutation__
 *
 * To run a mutation, you first call `usePutPageMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `usePutPageMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [putPageMutation, { data, loading, error }] = usePutPageMutation({
 *   variables: {
 *      id: // value for 'id'
 *      beforePage: // value for 'beforePage'
 *      image: // value for 'image'
 *   },
 * });
 */
export function usePutPageMutation(baseOptions?: Apollo.MutationHookOptions<PutPageMutation, PutPageMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<PutPageMutation, PutPageMutationVariables>(PutPageDocument, options);
      }
export type PutPageMutationHookResult = ReturnType<typeof usePutPageMutation>;
export type PutPageMutationResult = Apollo.MutationResult<PutPageMutation>;
export type PutPageMutationOptions = Apollo.BaseMutationOptions<PutPageMutation, PutPageMutationVariables>;
export const SplitPagesDocument = gql`
    mutation splitPages($id: ID!, $pages: IntRange!, $type: SplitType) {
  split: splitPages(id: $id, pages: $pages, type: $type) {
    success
    code
  }
}
    `;
export type SplitPagesMutationFn = Apollo.MutationFunction<SplitPagesMutation, SplitPagesMutationVariables>;

/**
 * __useSplitPagesMutation__
 *
 * To run a mutation, you first call `useSplitPagesMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSplitPagesMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [splitPagesMutation, { data, loading, error }] = useSplitPagesMutation({
 *   variables: {
 *      id: // value for 'id'
 *      pages: // value for 'pages'
 *      type: // value for 'type'
 ...
 * });
 */
export function useSplitPagesMutation(baseOptions?: Apollo.MutationHookOptions<SplitPagesMutation, SplitPagesMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SplitPagesMutation, SplitPagesMutationVariables>(SplitPagesDocument, options);
      }
export type SplitPagesMutationHookResult = ReturnType<typeof useSplitPagesMutation>;
export type SplitPagesMutationResult = Apollo.MutationResult<SplitPagesMutation>;
export type SplitPagesMutationOptions = Apollo.BaseMutationOptions<SplitPagesMutation, SplitPagesMutationVariables>;
