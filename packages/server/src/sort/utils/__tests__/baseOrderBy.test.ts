...
describe('baseOrderBy()', () => {
  describe('sorting flat arrays', () => {
    ...
    describe('all data types', () => {
      ...
      const symbol = Symbol();
      const date = new Date('2018-06-21');
      const origArray = [
        undefined,
        arr,
        null,
    ...
    describe('numerations', () => {
      const origArray = [2, 1, 5, 8, 6, 9];
      const sortArray = [1, 2, 5, 6, 8, 9];
      it(`${origArray.toString()} should be returned as ${sortArray.toString()}`, () => {
        expect(
          baseOrderBy(
            origArray,
    ...
    describe('descending support', () => {
      describe('descending pre-sorted array', () => {
      ...
      describe('descending unsorted array', () => {
        const origArray = ['a', 'c', 'e', 'b', 'd', 'f'];
        const sortArray = ['f', 'e', 'd', 'c', 'b', 'a'];
        it(`${origArray.toString()} should be returned as ${sortArray.toString()}`, () => {
          expect(baseOrderBy(origArray, [v => v], ['desc'])).toEqual(sortArray);
      ...
      describe('ascending pre-sorted array', () => {
        const origArray = ['a', 'c', 'e', 'b', 'd', 'f'];
        const sortArray = ['a', 'b', 'c', 'd', 'e', 'f'];
        it(`${origArray.toString()} should be returned as ${sortArray.toString()}`, () => {
          expect(baseOrderBy(origArray, [v => v], ['asc'])).toEqual(sortArray);
        });
      });
      describe('ascending unsorted array', () => {
  ...
  describe('sorting array of objects', () => {
    it('should return array in original order (stable sort)', () => {
      const origArray = [
        {
          user: 'Barney',
          age: 36,
    ...
    it('should order by user ascending (default) and age ascending (default) using functional identifiers', () => {
      const origArray = [
        {
          username: 'Fred',
          ip: '192.168.0.1',
          datetime: 'Mon Apr 02 2018 00:00:00 GMT-0500 (Eastern Standard Time)',
        },
        {
          username: 'betty',
          ip: '192.168.0.12',
          datetime: 'Wednesday, May 2, 2018 1:45 PM',
        },
        {
          username: 'Barney',
          ip: '192.168.1.1',
      ...
      expect(
        baseOrderBy(origArray, [v => v.datetime, v => v.ip], ['desc', 'asc']),
      ).toEqual(sortArray);
    });
  });
