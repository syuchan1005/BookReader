module.exports = {
  ...
  resolveLoader: {
    modules: [
      `${__dirname}node_modules/@vue/cli-plugin-eslint/node_modules`,
        ...
        oneOf: [
          /* config.module.rule('css').oneOf('vue-modules') */
          {
            ...
            use: [
              ...
              {
                loader: `${__dirname}node_modules/mini-css-extract-plugin/dist/loader.js`,
                options: {
                  hmr: false,
                  publicPath: '../',
                },
